...
let familyCollection = ["Derek", "Kaylee", "Brian", "Melanie", "Carter", "Tyler"]
let sortedCollection1 = familyCollection.sorted(by: forwards)
...
let sortedCollection2 = familyCollection.sorted { (name1, name2) -> Bool in
    name1 < name2
}
...
let sortedCollection3 = familyCollection.sorted(by: <)
/*:
